...
public class Links extends TableImpl<LinksRecord> {
     ...
     * Function)}.
     */
    public <U> SelectField<U> mapping(Class<U> toType, Function6<? super Long, ? super String, ? super OffsetDateTime, ? super OffsetDateTime, ? super BaseUrlType, ? super JSON, ? extends U> from) {
