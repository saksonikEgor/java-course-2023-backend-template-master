...
public class Links extends TableImpl<LinksRecord> {
    ...
    public final TableField<LinksRecord, String> URL =
        createField(DSL.name("url"), SQLDataType.VARCHAR(2048).nullable(false), this, "");
    /**
     * The column <code>LINKS.LAST_UPDATE</code>.
     */
    public final TableField<LinksRecord, OffsetDateTime> LAST_UPDATE = createField(DSL.name("last_update"),
     ...
     */
    public final TableField<LinksRecord, OffsetDateTime> LAST_CHECK = createField(DSL.name("last_check"),
        SQLDataType.TIMESTAMPWITHTIMEZONE(6).nullable(false)
            .defaultValue(DSL.field(DSL.raw("LOCALTIMESTAMP"), SQLDataType.TIMESTAMPWITHTIMEZONE)),
        this,
        ""
     ...
     */
    public final TableField<LinksRecord, BaseUrlType> BASE_URL = createField(DSL.name("base_url"),
        SQLDataType.VARCHAR.nullable(false).asEnumDataType(edu.java.domain.jooq.enums.BaseUrlType.class),
        this,
        ""
    );
    /**
     ...
     */
    public final TableField<LinksRecord, JSON> INFO =
        createField(DSL.name("info"), SQLDataType.JSON.nullable(false), this, "");
     ...
     */
    public <U> SelectField<U> mapping(Function6<? super Long, ? super String, ? super OffsetDateTime, ? super OffsetDateTime, ? super BaseUrlType, ? super JSON, ? extends U> from) {
    ...
    public <U> SelectField<U> mapping(
        Class<U> toType,
        Function6<? super Long, ? super String, ? super OffsetDateTime, ? super OffsetDateTime, ? super BaseUrlType, ? super JSON, ? extends U> from
    ) {
