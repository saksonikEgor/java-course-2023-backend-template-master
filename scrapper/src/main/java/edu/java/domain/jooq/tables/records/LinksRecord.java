...
public class LinksRecord extends UpdatableRecordImpl<LinksRecord> implements Record6<Long, String, OffsetDateTime, OffsetDateTime, BaseUrlType, JSON> {
    ...
    @Override
    @NotNull
    public LinksRecord values(@Nullable Long value1, @NotNull String value2, @Nullable OffsetDateTime value3, @Nullable OffsetDateTime value4, @NotNull BaseUrlType value5, @NotNull JSON value6) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
    ...
    public LinksRecord(@Nullable Long linkId, @NotNull String url, @Nullable OffsetDateTime lastUpdate, @Nullable OffsetDateTime lastCheck, @NotNull BaseUrlType baseUrl, @NotNull JSON info) {
        super(Links.LINKS);
